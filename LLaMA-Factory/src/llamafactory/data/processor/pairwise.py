...
class PairwiseDatasetProcessor(DatasetProcessor):
    ...
    def preprocess_dataset(self, examples: dict[str, list[Any]]) -> dict[str, list[Any]]:
        ...
        for i in range(len(examples["_prompt"])):
            ...
            # m-WSPO: optional pre-mined hard-negative images and stable sample id
            if "_images_neg" in examples:
                model_inputs["images_neg"].append(examples["_images_neg"][i])

            if "_sample_id" in examples:
                model_inputs["sample_id"].append(examples["_sample_id"][i])
