...
class AlpacaDatasetConverter(DatasetConverter):
    def __call__(self, example: dict[str, Any]) -> dict[str, Any]:
        ...
        output = {
            ...
            "_images_neg": (
                self._find_medias(example[self.dataset_attr.images_neg]) if self.dataset_attr.images_neg else None
            ),
        }
        return output
...
def align_dataset(
    ...
    _videos:     []
    _audios:     []
    _images_neg: [] | None  -- m-WSPO pre-mined hard-negative images
    """
